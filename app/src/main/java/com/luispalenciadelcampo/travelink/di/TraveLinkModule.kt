...
object TraveLinkModule {
    ...
    fun provideUseCases(authRepository: AuthRepository, mainRepository: MainRepository): UseCase {
        return UseCase(
            ...
            RateTripUseCase = RateTripUseCase(mainRepository),
            ...
            UploadProfileImageUseCase = UploadProfileImageUseCase(mainRepository),
            RateEventUseCase = RateEventUseCase(mainRepository)
        )
    }
}