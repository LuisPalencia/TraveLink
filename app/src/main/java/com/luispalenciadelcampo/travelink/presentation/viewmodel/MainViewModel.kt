...
class MainViewModel @Inject constructor(
    ...
    var rateTripStatus = MutableLiveData<Resource<Boolean>>()
    var rateEventStatus = MutableLiveData<Resource<Boolean>>()
    ...
    var getTripPlacePhotoStatus = MutableLiveData<Resource<String>>()
    var getEventPlacePhotoStatus = MutableLiveData<Resource<String>>()
    ...
    suspend fun rateTrip(rating: Double, trip: Trip){
        viewModelScope.launch(Dispatchers.Main) {
            ...
            rateTripStatus = MutableLiveData<Resource<Boolean>>()
        }
    }

    suspend fun rateEvent(rating: Double, eventId: String, tripId: String){
        viewModelScope.launch(Dispatchers.Main) {
            val resultRateEvent = useCase.RateEventUseCase(eventId, tripId, rating)
            rateEventStatus.postValue(resultRateEvent)
            rateEventStatus = MutableLiveData<Resource<Boolean>>()
        }
    }
 ...
 */
    ...
    suspend fun getTripImage(trip: Trip, userId: String){
        viewModelScope.launch(Dispatchers.IO) {
            ...
            getTripPlacePhotoStatus = MutableLiveData<Resource<String>>()
    ...
    suspend fun getEventImage(idTrip: String, event: Event){
        viewModelScope.launch(Dispatchers.IO) {
            ...
            getEventPlacePhotoStatus = MutableLiveData<Resource<String>>()
        }
